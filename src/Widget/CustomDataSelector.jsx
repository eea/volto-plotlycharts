...
import DropdownWidget from './CustomDropdownWidget';
...
export class UnconnectedDataSelector extends Component {
  ...
  setLocals(props, context) {
    ...
    console.log('dataSourceOptions is wrong:', this.dataSourceOptions);
  ...
  render() {
    ...
    // console.log('CUSTOM DATA SELECTOR fullValue', );
    console.log('dataSourceOptions on Render:', this.dataSourceOptions);
