...
import { AxesCreator, TraceSelector } from '../fields';

const StructureGraphCreatePanel = (props, { localize: _, setPanel }) => {
  return (
    <TraceAccordion
      canAdd
...
export default StructureGraphCreatePanel;
StructureGraphCreatePanel.contextTypes = {
