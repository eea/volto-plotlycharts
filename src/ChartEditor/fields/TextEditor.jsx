...
import LaTeX from 'react-chart-editor/lib/components/widgets/text_editors/LaTeX';
import RichText from 'react-chart-editor/lib/components/widgets/text_editors/RichText';
import MultiFormat from 'react-chart-editor/lib/components/widgets/text_editors/MultiFormat';
import HTML from 'react-chart-editor/lib/components/widgets/text_editors/HTML';
...
export class UnconnectedTextEditor extends Component {
  ...
  render() {
    const { attr, container, htmlOnly, latexOnly, multiValued, richTextOnly } =
      this.props;
    ...
    if (
      multiValued ||
      (fullValue && (!container || !nestedProperty(container, attr)))
    ) {
